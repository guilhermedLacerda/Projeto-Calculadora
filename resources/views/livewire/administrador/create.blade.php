<div>
    <div class="mt-5">
        ...
        <div class="card mx-auto my-5 shadow-lg p-3 mb-5 bg-white rounded w-75">
            ...
            <div class="card-body ">
                <p class="d-flex justify-content-center mb-0"><ins><strong>Administrador</strong></ins></p>
                <form wire:submit.prevent="store">
                    ...
                    <div class="mb-3">
                        <label for="email_educacional">Email</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="cpf" id="cpf" rows="5" wire:model.defer="cpf" placeholder="Insira seu CPF"></input>
                    </div>
                    ...
                    <div class="d-flex justify-content-center">
                        <p class="mx-1">cadastrar-se como</p>  <a href="#" target="_blank" class="text-primary ml-5">Professor</a> <p> / </p> <a href="../usuario/create.blade.php" target="_blank" class="text-primary ml-5">Aluno</a>
                    </div>
                </form>
